...
/*   Updated: 2023/08/11 11:54:43 by fbosch           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_color_gradient(int start_color, int end_color, int len, int progress)
{
	double	increment[3];
	int		new[3];
	int		newcolor;
	...
	new[0] = (R(start_color)) + round(progress * increment[0]);
	new[1] = (G(start_color)) + round(progress * increment[1]);
	new[2] = (B(start_color)) + round(progress * increment[2]);
